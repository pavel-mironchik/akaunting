...
return [
    ...
    'warning' => [
        'deleted'           => 'Ettevaatus:  Teil pole lubatud kustutada <b>:name</b> kuna see on seotud :text.',
        'disabled'          => 'Ettevaatus: Teil pole lubatud keelata  <b>:name</b> kuna see on seotud :text.',
        'reconciled_tran'   => 'Ettevaatus: Teil pole lubatud tehingut muuta/kustutada, kuna see on vastavusse viidud!',
        'reconciled_doc'    => 'Ettevaatus: :type pole lubatud muuta/kustutada, kuna see on seotud vastavusse viidud tehingutega!',
        'disable_code'      => 'Ettevaatus: <b>:name</b>  valuutat pole lubatud muuta/kustutada, kuna see on seotud :text.',
        'payment_cancel'    => 'Ettevaatus: Olete tühistanud oma hiljutise makseviisi :method!',
    ],
